<?php
    ...
    $aboutInfos           = 'Unter dem Motto Code your World findet am 12.04.2016 der zweite Dev Day in der Börse Dresden statt. Von 12:00 Uhr bis ca. 21:00 Uhr besteht die Möglichkeit, sich in entspannter und lockerer Atmosphäre bei Hot Dogs und kühlen Getränken auszutauschen und mit anderen zu vernetzen. Die Teilnahme ist kostenlos und auch für freies WLAN wird gesorgt sein. Mehr Informationen zur Location und zur Anfahrt findet Ihr <a href="#anfahrt">hier</a>.';
    $whichHeadline        = 'FÜR WEN IST DER DEVDAY?';
    ...
    $registerOptional     = 'Wie bist Du auf den DevDay aufmerksam geworden?';
    $registerChooseNumber = 'Bitte wähle Nummer : ';
    $registerSubmit       = 'Jetzt Anmelden';

    // Sponsoren
    $sponsorsHeadline     = 'Unsere Partner';
    $sponsorsText         = 'Ein Dank geht an unsere Partner ohne die der DevDay 2016 nicht möglich wäre.';
