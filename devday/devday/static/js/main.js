 ...
 * http://modernizr.com/download/?-flexbox-flexboxlegacy-addtest !*/
!function(e,n,t){function o(e,n){return typeof e===n}function r(){var e,n,t,r,i,s,l;for(var a in C)if(C.hasOwnProperty(a)){if(e=[],n=C[a],n.name&&(e.push(n.name.toLowerCase()),n.options&&n.options.aliases&&n.options.aliases.length))for(t=0;t<n.options.aliases.length;t++)e.push(n.options.aliases[t].toLowerCase());for(r=o(n.fn,"function")?n.fn():n.fn,i=0;i<e.length;i++)s=e[i],l=s.split("."),1===l.length?Modernizr[l[0]]=r:(!Modernizr[l[0]]||Modernizr[l[0]]instanceof Boolean||(Modernizr[l[0]]=new Boolean(Modernizr[l[0]])),Modernizr[l[0]][l[1]]=r),_.push((r?"":"no-")+l.join("-"))}}function i(e){var n=b.className,t=Modernizr._config.classPrefix||"";if(S&&(n=n.baseVal),Modernizr._config.enableJSClass){var o=new RegExp("(^|\\s)"+t+"no-js(\\s|$)");n=n.replace(o,"$1"+t+"js$2")}Modernizr._config.enableClasses&&(n+=" "+t+e.join(" "+t),S?b.className.baseVal=n:b.className=n)}function s(e,n){if("object"==typeof e)for(var t in e)x(e,t)&&s(t,e[t]);else{e=e.toLowerCase();var o=e.split("."),r=Modernizr[o[0]];if(2==o.length&&(r=r[o[1]]),"undefined"!=typeof r)return Modernizr;n="function"==typeof n?n():n,1==o.length?Modernizr[o[0]]=n:(!Modernizr[o[0]]||Modernizr[o[0]]instanceof Boolean||(Modernizr[o[0]]=new Boolean(Modernizr[o[0]])),Modernizr[o[0]][o[1]]=n),i([(n&&0!=n?"":"no-")+o.join("-")]),Modernizr._trigger(e,n)}return Modernizr}function l(e,n){return!!~(""+e).indexOf(n)}function a(e){return e.replace(/([a-z])-([a-z])/g,function(e,n,t){return n+t.toUpperCase()}).replace(/^-/,"")}function f(){return"function"!=typeof n.createElement?n.createElement(arguments[0]):S?n.createElementNS.call(n,"http://www.w3.org/2000/svg",arguments[0]):n.createElement.apply(n,arguments)}function u(e,n){return function(){return e.apply(n,arguments)}}function c(e,n,t){var r;for(var i in e)if(e[i]in n)return t===!1?e[i]:(r=n[e[i]],o(r,"function")?u(r,t||n):r);return!1}function d(e){return e.replace(/([A-Z])/g,function(e,n){return"-"+n.toLowerCase()}).replace(/^ms-/,"-ms-")}function p(){var e=n.body;return e||(e=f(S?"svg":"body"),e.fake=!0),e}function h(e,t,o,r){var i,s,l,a,u="modernizr",c=f("div"),d=p();if(parseInt(o,10))for(;o--;)l=f("div"),l.id=r?r[o]:u+(o+1),c.appendChild(l);return i=f("style"),i.type="text/css",i.id="s"+u,(d.fake?d:c).appendChild(i),d.appendChild(c),i.styleSheet?i.styleSheet.cssText=e:i.appendChild(n.createTextNode(e)),c.id=u,d.fake&&(d.style.background="",d.style.overflow="hidden",a=b.style.overflow,b.style.overflow="hidden",b.appendChild(d)),s=t(c,e),d.fake?(d.parentNode.removeChild(d),b.style.overflow=a,b.offsetHeight):c.parentNode.removeChild(c),!!s}function m(n,o){var r=n.length;if("CSS"in e&&"supports"in e.CSS){for(;r--;)if(e.CSS.supports(d(n[r]),o))return!0;return!1}if("CSSSupportsRule"in e){for(var i=[];r--;)i.push("("+d(n[r])+":"+o+")");return i=i.join(" or "),h("@supports ("+i+") { #modernizr { position: absolute; } }",function(e){return"absolute"==getComputedStyle(e,null).position})}return t}function v(e,n,r,i){function s(){c&&(delete z.style,delete z.modElem)}if(i=o(i,"undefined")?!1:i,!o(r,"undefined")){var u=m(e,r);if(!o(u,"undefined"))return u}for(var c,d,p,h,v,y=["modernizr","tspan"];!z.style;)c=!0,z.modElem=f(y.shift()),z.style=z.modElem.style;for(p=e.length,d=0;p>d;d++)if(h=e[d],v=z.style[h],l(h,"-")&&(h=a(h)),z.style[h]!==t){if(i||o(r,"undefined"))return s(),"pfx"==n?h:!0;try{z.style[h]=r}catch(g){}if(z.style[h]!=v)return s(),"pfx"==n?h:!0}return s(),!1}function y(e,n,t,r,i){var s=e.charAt(0).toUpperCase()+e.slice(1),l=(e+" "+T.join(s+" ")+s).split(" ");return o(n,"string")||o(n,"undefined")?v(l,n,r,i):(l=(e+" "+E.join(s+" ")+s).split(" "),c(l,n,t))}function g(e,n,o){return y(e,t,t,n,o)}var _=[],C=[],w={_version:"3.2.0",_config:{classPrefix:"",enableClasses:!0,enableJSClass:!0,usePrefixes:!0},_q:[],on:function(e,n){var t=this;setTimeout(function(){n(t[e])},0)},addTest:function(e,n,t){C.push({name:e,fn:n,options:t})},addAsyncTest:function(e){C.push({name:null,fn:e})}},Modernizr=function(){};Modernizr.prototype=w,Modernizr=new Modernizr;var x,b=n.documentElement,S="svg"===b.nodeName.toLowerCase();!function(){var e={}.hasOwnProperty;x=o(e,"undefined")||o(e.call,"undefined")?function(e,n){return n in e&&o(e.constructor.prototype[n],"undefined")}:function(n,t){return e.call(n,t)}}(),w._l={},w.on=function(e,n){this._l[e]||(this._l[e]=[]),this._l[e].push(n),Modernizr.hasOwnProperty(e)&&setTimeout(function(){Modernizr._trigger(e,Modernizr[e])},0)},w._trigger=function(e,n){if(this._l[e]){var t=this._l[e];setTimeout(function(){var e,o;for(e=0;e<t.length;e++)(o=t[e])(n)},0),delete this._l[e]}},Modernizr._q.push(function(){w.addTest=s});var P="Moz O ms Webkit",T=w._config.usePrefixes?P.split(" "):[];w._cssomPrefixes=T;var E=w._config.usePrefixes?P.toLowerCase().split(" "):[];w._domPrefixes=E;var j={elem:f("modernizr")};Modernizr._q.push(function(){delete j.elem});var z={style:j.elem.style};Modernizr._q.unshift(function(){delete z.style}),w.testAllProps=y,w.testAllProps=g,Modernizr.addTest("flexbox",g("flexBasis","1px",!0)),Modernizr.addTest("flexboxlegacy",g("boxDirection","reverse",!0)),r(),i(_),delete w.addTest,delete w.addAsyncTest;for(var N=0;N<Modernizr._q.length;N++)Modernizr._q[N]();e.Modernizr=Modernizr}(window,document);
/**
 * Build on 2017-9-5
 * @package devday17-frontend
 * @version v1.0.0
...
(function($) {
  ...
  $.fn.bsPhotoGallery = function(options) {
      ...
      function createModalWrap(){
        ...
        var modal = '';
        modal += '<div class="modal fade gallery-modal" id="bsPhotoGalleryModal" tabindex="-1" role="dialog"';
...
var Layer = function($element) {
    ...
    that.$body           = $('body');
    that.$html           = $('html');
    that.$triggerElement = $element || $('[data-toggle="modal"]');
    that.$layer          = null;
    that.$layerDialog    = null;
    that.$modalHeader    = null;
    that.$modalBody      = null;
    that.$modalFooter    = null;
    that.$enhancedFooter = false;

    /**
     * other Vars
     */
    that.canBeHide       = false;
    that.addTopSpacing   = 120;

    that.initLayer = function(){
        that.$layer       = $(that.$triggerElement.attr('data-target'));
        that.$layerDialog = that.$layer.find('.modal-dialog');

        that.$layer.on('shown.bs.modal', that.onShown);

        that.$modalHeader =  that.$layerDialog.find('.modal-header');
        that.$modalBody   =  that.$layerDialog.find('.modal-body');
        that.$modalFooter =  that.$layerDialog.find('.modal-footer');
    };

    that.setBodyMaxHeight = function() {
        if (that.$layer.hasClass('modal-enhanced-footer')) {
            that.$enhancedFooter = true;
            that.addTopSpacing   = 64;
            that.$modalBody.mCustomScrollbar('update');
            that.calculateFooter();
        }

        var layerFullHeight = that.$body.height() - that.$modalHeader.height() - that.$modalFooter.outerHeight();
        var height          = layerFullHeight - that.addTopSpacing;

        that.$modalBody.css('max-height',height+'px');
    };

    that.calculateFooter = function() {
        var $modal = that.$layer;
        var $modalFooter = $modal.find('.modal-footer');
        var $modalBody = $modal.find('.modal-body');
        var $modalBodyHeight = $modalBody.height();

        $modalFooter.css('height', 'auto');
        var $modalFooterHeight = $modalFooter.height();

        $modalFooter.css('top', '-' + $modalFooterHeight);

        $modalBody.css('padding-bottom',  34)

    }

    that.onShown = function () {


        that.setBodyMaxHeight();
        var isNoCloseButton = that.$layerDialog.find('button.close').length < 1;
        if(isNoCloseButton) {
           that.$layer.on('hide.bs.modal', function(event) {
              if(!that.canBeHide) {
                  event.stopPropagation();
                  event.preventDefault();
              }
              window.setTimeout(function() { that.canBeHide = false; }, 100);
           });
        }
    };
 ...
 * "startUp" method and bound to "window.JS".
 */
var JsRegistry = function() {
    ...
    that.promoHandling = function() {

        var windowHeight = $(window).height();
        var windowWidth  = $(window).width();
        var promoArea    = $('.promo:not(.site)');
        var callToAction = promoArea.find('.call-to-action');

        promoArea.height(windowHeight + 200);

        /*if (windowHeight > windowWidth || windowWidth < 768) {
            promoArea.addClass('cover');
        } else {
            promoArea.removeClass('cover');
        }*/

        var marginCallToAction = (windowHeight / 2) - callToAction.height();

        callToAction.css('margin-top', marginCallToAction);


    };

    that.promoEyecatcher = function() {
        if ($('body').hasClass('dd-2018')) {
            var eyecatchContainer = $('<div>').addClass('head-svg');
            var promoArea = $('.promo');
            promoArea.append(eyecatchContainer);
        }
    }

    that.menuHandling = function() {
         $('.menu-trigger').on('click', function(event) {
            event.preventDefault();
            var parent = $(this).parent('li');
            parent.toggleClass('active');
            parent.find('ul').width($(window).width());
            /* Act on the event */
        });
    };
    ...
    that.carouselHandler = function() {
        var twitterAreaHeight = $('.twitter-area').outerHeight();
        $('#twitterCarousel').height(twitterAreaHeight);
        $('#twitterCarousel').find('.item').height(twitterAreaHeight);
    ...
    that.formHandler = function() {
        $('.checkbox').click(function(e) {
            e.preventDefault();

            var checkbox = $(this).find('input'),   // keep reference of checkbox
    ...
    that.twitterHandler = function() {
        that.carouselHandler();
    };

    that.galleryHandler = function() {
