...
class SponsoringViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        package1.sponsoringpackageitem_set.create(name="Bronze 1", is_header=True)
        ...
        package2.sponsoringpackageitem_set.create(name="Silver 1", is_header=True)
        ...
        package3.sponsoringpackageitem_set.create(name="Gold 1", is_header=True)
