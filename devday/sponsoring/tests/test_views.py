...
class SponsoringViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        package1.sponsoringpackageitem_set.create(name="Silver 1", is_header=True)
        package1.sponsoringpackageitem_set.create(name="Silver Nice")
        package1.sponsoringpackageitem_set.create(name="Silver so wow")
        package1.sponsoringpackageitem_set.create(name="Fine Silver")
        package2.sponsoringpackageitem_set.create(name="Gold 1", is_header=True)
        package2.sponsoringpackageitem_set.create(name="Gold Nice")
        package2.sponsoringpackageitem_set.create(name="Gold so wow")
        package2.sponsoringpackageitem_set.create(name="Fine Gold")
        package3.sponsoringpackageitem_set.create(name="Platinum 1", is_header=True)
        package3.sponsoringpackageitem_set.create(name="Platinum Nice")
        package3.sponsoringpackageitem_set.create(name="Platinum so wow")
        package3.sponsoringpackageitem_set.create(name="Fine Platinum")
