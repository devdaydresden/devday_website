...
var Layer = function($element) {
    ...
    that.onShown = function () {
        ...
        if(isNoCloseButton) {
           ...
           that.$layer.on('click', function(event) {
              var $target = $(event.originalEvent.target);
              var $dismiss = $target.parents('[data-dismiss]');

              if($target.hasClass('modal') || $dismiss.length < 1) {
                  return false;
              } else {
                  that.canBeHide = true;
                  that.$layer.modal('hide');
              }
    ...
    that.handleFileInputsInModal = function() {
      $(document).find('.modal').on('change', ':file', function(e) {
        var input = $(this),
      ...
      $(document).ready( function() {
          $('.modal').find(':file').on('fileselect', function(event, numFiles, label) {
...
var JsRegistry = function() {
    ...
    that.carouselHandler = function() {
        var twitterAreaHeight = $('.twitter-area').height();
