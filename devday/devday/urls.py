...
from attendee.views import AttendeeCancelView, AttendeeProfileView, AttendeeRegistrationView
...
urlpatterns = [
    ...
    url(r'^accounts/cancel/(?P<event>\d+)$', AttendeeCancelView.as_view(), name='attendee_cancel'),
